...
public class CorrTest extends UnitTest {
    ...
    public void testSpearman() throws Exception {
    	Scanner scan = new Scanner(new File("../../SmileOperators/src/main/resources/SimpleTestCoded.csv"));
    	scan.nextLine();
    ...
    public void testDelay() throws Exception {
    	Scanner scan = new Scanner(new File("../../SmileOperators/src/main/resources/toyTesting.csv"));
    	scan.nextLine();
    	int size = 20000;
    ...
    public void enqueueTuple(Enqueuer enqueuer) throws Exception {
