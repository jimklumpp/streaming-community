...
public class CreateDecisionTable {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            properties.add(new Prop("EffectiveDate", "String", "2018-03-22 15:06:39"));
            properties.add(new Prop("ExpiryDate", "String", "2018-03-23 15:06:41"));
    ...
    private static void serialize(Table table, File file) throws Exception {
        ...
        m.marshal(new JAXBElement<Table>(new QName(table.getClass().getSimpleName()), Table.class, table), writer);
