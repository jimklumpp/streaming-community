...
tab of the EventFlow Editor for BollingerBandSignaling.sbapp. The parameters 
are:
    WindowSize:  The period or number of observations of the simple moving 
                 average.
    K:           The number of standard deviations to use for the high and 
                 low Bollinger bands.
