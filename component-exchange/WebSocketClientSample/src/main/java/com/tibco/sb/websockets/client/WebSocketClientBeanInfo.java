 ...
 */
public class WebSocketClientBeanInfo extends SBSimpleBeanInfo {
	...
	public SBPropertyDescriptor[] getPropertyDescriptorsChecked()
		...
		SBPropertyDescriptor[] p = {
				new SBPropertyDescriptor("uri", WebSocketClient.class)
						.displayName("URI").description(""),
				new SBPropertyDescriptor("contextPath", WebSocketClient.class)
						.displayName("Context Path").description(""), };
		return p;
	}
