...
=============================
	...
	- In order for this demo to work, you will need access to a WebSocket server. There is a WebSocket 
	  server project provided by StreamBase which is accessible by going to:
	  File > Load StreamBase Sample
	  StreamBase Standard Adapters > Web Server Request Response adapters
...
=============================
	...
	- Right-click on "WebSocketClientSample" in the Package Explorer on the left and select:
	  Run As > StreamBase LiveView Project.
	  
	- Right-click on "WebSocketClientSample.sbapp" in the Package Explorer on the left and select:
	  Run As > StreamBase Application.
	...
	- Open "client.html" with a standard web browser (do not use the web browser inside Studio as 
	...
	- In LiveView Desktop, enter a message in the "inputMessage" text box on the right and click the "Submit"
